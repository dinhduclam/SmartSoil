...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logo-48px.png" rel="icon">
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:dinhduclam2001@gmail.com" target="_blank"><span class="email-address"></span></a>
        <i class="bi bi-phone-fill phone-icon"></i> <span class="phone-number"></span>
      </div>
  ...
  <!-- ======= Header ======= -->
  <header id="header" style="background-color: #fbfbfb;" class="d-flex align-items-center">
  ...
  <main id="main">
    ...
    <section id="main-product" class="main-production">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/product/product1.png" class="img-fluid" alt="">
          </div>
    ...
    <section id="feature" class="feature">
      <div class="container">
        ...
        <div class="section-title">
          <h2>SmartSoil's Features</h2>
          <!-- <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p> -->
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-lg-0 mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              <div class="icon">
                ...
                <i><img src="https://img.icons8.com/bubbles/50/000000/sprout.png"/></i>
              </div>
              <h4>Enhance Plant Growth</h4>
              <p>Water and nutrients are continuously available in the root zone for optimal absorption by plants.</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-lg-0 mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              <div class="icon">
                ...
                <i><img src="https://img.icons8.com/bubbles/50/000000/soil.png"/></i>
              </div>
              <h4>Improve Soil Condition</h4>
              <p>Improves the physical properties of compact soils through good aeration.</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-lg-0 mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              <div class="icon">
                ...
                <i><img src="https://img.icons8.com/color/48/000000/environment-care.png"/></i>
              </div>
              <h4>Protect Environment</h4>
              <p>Protects the environment against drought and groundwater pollution.</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow" style="flex: 1;">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                ...
                <i><img src="https://img.icons8.com/bubbles/50/000000/water.png"/></i>
              </div>
              <h4>Reduce Losses</h4>
              <p>Limits losses of water and nutrients due to leaching.</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red" style="flex: 1;">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                ...
                <i><img src="https://img.icons8.com/color/48/000000/plant-under-rain.png"/></i>
              </div>
              <h4>Save Irrigation</h4>
              <p>Increases the water holding capacity of soils for several years. Irrigation frequency may be reduced by 50%.</p>
            </div>
          </div>

          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal" style="flex: 1;">
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                ...
                <i><img src="https://img.icons8.com/cotton/64/000000/evaporation.png"/></i>
              </div>
              <h4>Reduce Evaporation</h4>
              <p>Reduces evaporation from the soil.</p>
            </div>
          </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>334 Nguyen Trai Str., Thanh Xuan Dist, Hanoi, Vietnam</p>
              </div>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.919289577641!2d105.80578315075165!3d20.995872185947608!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135acbf0df2c0e5%3A0xd740a66998e1a0ed!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBLaG9hIGjhu41jIFThu7Egbmhpw6puLCDEkOG6oWkgaOG7jWMgUXXhu5FjIGdpYSBIw6AgTuG7mWk!5e0!3m2!1svi!2s!4v1627440564640!5m2!1svi!2s" width="100%" height="250" style="border:0;" allowfullscreen=""></iframe>
            </div>
